...
<div class="wrap">
  ...
  <div class="stats">
    <div class="stat"><div class="k">HP</div><div class="v">1900</div><div class="sub">the anvil, not the hammer</div></div>
    <div class="stat"><div class="k">ATK</div><div class="v">175</div></div>
    <div class="stat def"><div class="k">DEF</div><div class="v">155</div><div class="sub">+30% on a front hex</div></div>
  ...
  <div class="abilities">
    ...
    <div class="ability">
      ...
      front row, and every one of them is <b>taunted onto her needle</b>.
      This is the setup &#x2014; every swing they answer with lands on the
      bond as well.</p>
    </div>
    <div class="ability">
      <div class="slot">Skill 3 &middot; Cooldown 5 &middot; One at a time</div>
      <h3>Soul Bond</h3>
