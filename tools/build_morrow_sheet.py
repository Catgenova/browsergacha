...
<div class="wrap">
  ...
  <div class="stats">
    <div class="stat"><div class="k">HP</div><div class="v">2500</div><div class="sub">the biggest body in the sect</div></div>
    <div class="stat"><div class="k">ATK</div><div class="v">110</div><div class="sub">unused &#x2014; he hits off DEF</div></div>
    <div class="stat def"><div class="k">DEF</div><div class="v">175</div><div class="sub">every number in his kit</div></div>
  ...
  <div class="abilities">
    ...
    <div class="ability">
      <div class="slot">Skill 2 &middot; Cooldown 5</div>
      <h3>Wisteria</h3>
      ...
      it: <b>the whole enemy team</b> is taunted onto him for a turn, and
      Morrow takes <b>+50% DEF for two</b>. Nothing else in the game
      taunts more than a row.</p>
    </div>
    <div class="ability">
      <div class="slot">Skill 3 &middot; Cooldown 6</div>
      <h3>Pallbearer</h3>
