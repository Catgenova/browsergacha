...
<div class="wrap">
  ...
  <div class="round-box">
    <div class="round">
      ...
      <div class="cell cast on" data-note="SPD"></div>
      <div class="cell cast on" data-note="ATK"></div>
      <div class="rowk">+30% SPD<small>whole party</small></div>
    ...
    <div class="round-cap">One possible six-turn round. <b>Processional has no cooldown</b>,
      so the party's +30% SPD simply never goes out &#x2014; and every point of speed his
  ...
  <div class="abilities">
    <div class="ability">
      ...
      <h3>Processional</h3>
      <div class="meta">All allies &middot; <b>+30% SPD, 2 turns</b></div>
