...
<div class="wrap">
  ...
  <div class="abilities">
    ...
    <div class="ability">
      <div class="slot">Skill 2 &middot; 4-turn cooldown &rarr; 2 fully levelled &middot; needs the stance</div>
      <h3>Lumen Arrow</h3>
    ...
    <div class="ability">
      <div class="slot">Skill 3 &middot; 3-turn cooldown &rarr; 1 fully levelled</div>
      <h3>Aiming Stance</h3>
  ...
  <div class="dmg-table-box">
    ...
    <div class="table-cap">Skill levels follow each skill&#x27;s own ladder &#x2014; see the <b>Skill ups</b> line on each card, and the level cap that comes with it. Levels are raised in Improve by sacrificing another copy. Aimed figures are the stance's &#xd7;2 applied to the leveled shot.</div>
  </div>
