...
<div class="wrap">
  ...
  <div class="abilities">
    ...
    <div class="ability">
      <div class="slot">Skill 2 &middot; 6-turn cooldown &rarr; 4 fully levelled</div>
    ...
    <div class="ability">
      <div class="slot">Skill 3 &middot; 8-turn cooldown &rarr; 6 fully levelled</div>
      <h3>Second Dawn</h3>
      ...
      <div class="ladder"><b>Skill ups</b> &middot; +5% heal &rsaquo; +5% heal &rsaquo; +5% heal &rsaquo; +5% heal &rsaquo; +5% heal &rsaquo; -1 cooldown &rsaquo; -1 cooldown <i>&middot; max Lv 8</i></div>
    </div>
  ...
  <div class="dmg-table-box">
    ...
    <div class="table-cap">Skill levels follow each skill&#x27;s own ladder &#x2014; see the <b>Skill ups</b> line on each card, and the level cap that comes with it. Levels are raised in Improve by sacrificing another copy. The revival's 40% is fixed: a second life doesn't scale.</div>
  </div>
