...
<div class="wrap">
  ...
  <div class="dmg-table-box">
    ...
    <div class="table-cap">Skill levels follow each skill&#x27;s own ladder &#x2014; see the <b>Skill ups</b> line on each card, and the level cap that comes with it. Levels are raised in Improve by sacrificing another copy. Chain chances never change; the dice are the dice.</div>
  </div>
