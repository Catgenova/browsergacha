...
<div class="wrap">
  ...
  <div class="abilities">
    ...
    <div class="ability">
      ...
      <p>Her reach past the front line: every enemy in the <b>back row</b>
      takes the hit and is <b>slowed 30% for two turns</b>. The slow is a
      contested roll like any debuff; the damage is not.</p>
  ...
  <div class="dmg-table-box">
    ...
    <div class="table-cap">Skill levels add +10% power per level (max Lv 5) &#x2014; raised in Improve by
      sacrificing another Noctelle. The cleanse, the &#x2212;30% slow and the Wind doubling are
