...
<div class="wrap">
  ...
  <div class="engine-box">
    <div class="engine-step"><b>Light it.</b> Cinder Lash leaves a burn
      eating <b>4% of the victim's max HP</b> every turn.</div>
    ...
    <div class="engine-step"><b>Cash out.</b> Wildfire Arc ricochets at
      <b>140% ATK per hit</b> &#x2014; and the forge already made that ATK bigger.</div>
  </div>
  ...
  <div class="odds-box">
    ...
    &#xd7; 140%), swinging from a single 140% lash to a run the table
    never forgets.</p>
  </div>
  ...
  <div class="abilities">
    ...
    <div class="ability">
      ...
      <h3>Wildfire Arc</h3>
      <div class="meta">Ricochet &middot; <b>140% ATK per hit</b></div>
