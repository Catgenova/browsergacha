...
<div class="wrap">
  ...
  <div class="stats">
    <div class="stat"><div class="k">HP</div><div class="v">945</div></div>
    <div class="stat atk"><div class="k">ATK</div><div class="v">202</div><div class="sub">before the tally starts</div></div>
    <div class="stat"><div class="k">DEF</div><div class="v">78</div></div>
  ...
  <div class="abilities">
    <div class="ability">
      ...
      <p>A shard off the staff crystal. Modest on its own &#x2014; but it rolls a <b>three-in-ten</b> freeze <b>every single
      turn</b>. Deliberately short of the 50% every other hex opens at:
      a lockout thrown every turn is not allowed to become certain.</p>
    ...
    <div class="ability">
      ...
      <p>A sphere of packed rime, conjured and hurled. The middle rung of the ladder: better damage, and a <b>coin-flip
      freeze</b> that skill ups carry all the way to certain.</p>
  ...
  <div class="dmg-table-box">
    ...
    <div class="table-cap">Skill levels follow each skill&#x27;s own ladder &#x2014; see the <b>Skill ups</b> line on each card, and the level cap that comes with it. Levels are raised in Improve by sacrificing another copy. The freeze odds and the tally's tenth are fixed.</div>
  </div>
