...
<div class="wrap">
  ...
  <div class="abilities">
    <div class="ability">
      ...
      <p>The drill dragged across the enemy line. It grinds, and <b>half the time</b> it strips &#x2014; the wall ahead is softer for whoever swings next.</p>
  ...
  <div class="dmg-table-box">
    ...
    <div class="table-cap">Skill levels follow each skill&#x27;s own ladder &#x2014; see the <b>Skill ups</b> line on each card, and the level cap that comes with it. Levels are raised in Improve by sacrificing another copy. The DEF strip, the hardening and Bedrock are fixed.</div>
  </div>
